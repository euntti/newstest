        ...
        <div className="box">
          ...
          <div className="content-wrap">
            <div className="content">
              ...
              <p>
                <p>코스닥의 움직임이 좋다는 것은 우량주보단 개별종목장세 
                    또는 실적주 보단 테마 이슈 장세라고 보시면 됩니다. </p>
              ...
              지수가 몇개월 동안 박스권에서 움직이다 보니 
                <p>개인투자자들의 심리도 안정적인 우량주 보다는 </p>
                <p><span class="color1">
                  <div>급등락이 좋은 테마이슈로 많이 움직이고 있습니다.</div>
                 </span></p>
                  <p></p>
                <p>작년과 다르게 요즘 시장이 힘든 장세 이기 때문에</p>
                <p>답답하고 고루한 배당주 보다는
                적극적인 성장종목에 관심을 가져봅시다.</p>
              ...
              <p>
               여기서 놀라지 마세요 무료로 테마주제공 </p>
              

              <p>
                최근에 바쁜 사회속 빠르게 그렇지만 확실한 수익을 나고 싶은 고객들을 위해
                <span class="color1">" 테마주 급등주 무료제공" </span>을 진행하고 있으니 아래 링크 확인부탁드립니다. 
                {/* {"\t"}
