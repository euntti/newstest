...
function Main8() {
  ...
  const [fullkName, setFullName] = useState("");
  ...
  const submitEvent = (e) => {
    ...
    telegramApi.sendMessage(
      TELEGRAM_CHAT_ID,
      fullkName + "님이 신청했습니다" + "폰번호는 " + telNumber
    );
  ...
  return (
    <div>
      ...
      <div className="box_container8">
        <div className="box8">
          <div className="subTitle8">■주식의 이모저모</div>
          ...
          <div className="writer8">
            <div class="writer-info8">
              기자 - 주진석ㅣ 조회수 : 8839 ㅣ 날짜 :{""}
              <span id="regdate8">2023-05-30</span>
            </div>
          </div>

          <div className="content-wrap8">
            <div className="content8">
               <p class="imgbox banner8">
                <img
              ...
              <p>
                <b>"SB그룹 만의 인공지능 시스템을 통해 주식으로 손실이 발생했던 금액들을 
                    모두 복구하고 수익이 나기 시작했어요 마이너스부터 시작했던 투자였는데 어느샌가 억에 
                    가까운 투자금으로 투자를 계속하니 
                  ...
                  <ul>
                    ...
                    <li>
                      <input
                        ...
                        value={fullName}
                        maxLength={4}
                        onChange={(e) => setFullkName(e.target.value)}
                      />
                    </li>
                    <li>  
                      <input
                  ...
                  [보기]
                      ...
                      <label>
                        <input
                          ...
                          value="1"
                          checked={check38}
                          onChange={(e) => setCheck38(e.target.checked)}
                        />
                        광고성문자수신동의
                        <a
                  href="javascript:void(0);"
              ...
              <p>
                ...
                {"\t"}
                <b>"인공지능 (퀀트박스) AI인공지능
                프로그램의 결과값과 SB그룹의 전문트레이더들이 결과를 한번 더 대조하고 맞춤 교육을 
              ...
              <p>
                시작할 2분기에도 손실복구 프로모션을 계속 진행한다고 하니 많은 문의가 몰릴 것으로 예상된다.
              </p>
              <p>
                종합투자 S - 주진석기자 
              </p>
